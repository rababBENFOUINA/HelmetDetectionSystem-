...
model = YOLO("C:\\Users\\HP\\Documents\\MIT\\Archi\\a7ssan model la l9ito\\best_1.pt")
    ...
    for results in results_list:
        ...
        if hasattr(results, 'boxes'):
            ...
            if len(indices_classes_detectees) > 0:
                for i in indices_classes_detectees:
                    if i == 2 :
...
with open("C:\\Users\\HP\\Documents\\MIT\\Archi\\projet\\encodings.pkl", "rb") as f:
...
###############################################################################
        ...
        if email_destinataire:
            ...
            corps_email = """
                        ...
                        Cordialement
                        """.format(utilisateur.get("nom"),utilisateur.get("Identifiant"),utilisateur.get("timestamp"))
